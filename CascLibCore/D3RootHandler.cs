...
namespace CASCExplorer
{
    ...
    public class CoreTOCParser
    {
        ...
        private readonly Dictionary<SNOGroup, string> extensions = new Dictionary<SNOGroup, string>
        {
            { SNOGroup.Code, "" },
            { SNOGroup.None, "" },
            { SNOGroup.Actor, ".acr" },
        ...
        private readonly Dictionary<int, SNOInfo> snoDic = new Dictionary<int, SNOInfo>();
    ...
    {
        private readonly Dictionary<string, string> nameToExtDic =
